    ...
    >
      <div className="container mx-auto px-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3 z-20">
          ...
          >
            {mobileMenuOpen ? <IoMdClose size={24} /> : <FaBars size={22} />}
          </motion.button>
        </div>
      </div>
      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          <motion.div
            ...
            className="md:hidden bg-[var(--secondary)] border-t border-[var(--neutral-light)]"
          >
            <div className="container mx-auto px-4 py-4">
              <div className="flex flex-col space-y-3">
                <div className="flex justify-center space-x-4 py-2 border-b border-[var(--neutral-light)]">
                  <LanguageToggle />
                  <ThemeToggle />
                </div>
                
                <Link href="/dashboard" className="p-2 text-[var(--foreground)] hover:text-[var(--primary)]">
                  Dashboard
                </Link>
                <Link href="/profile" className="p-2 text-[var(--foreground)] hover:text-[var(--primary)]">
                  My Profile
                </Link>
                <Link href="/settings" className="p-2 text-[var(--foreground)] hover:text-[var(--primary)]">
                  Settings
                </Link>
                <button 
                  onClick={handleLogout}
                  className="p-2 text-red-400 hover:text-red-500 flex items-center"
                >
